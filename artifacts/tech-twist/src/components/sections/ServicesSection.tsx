    ...
    services: [
      {
        ...
        image: `${import.meta.env.BASE_URL}images/slide-callcenter.jpg`,
      },
      {
        icon: PhoneOutgoing,
        ...
        image: `${import.meta.env.BASE_URL}images/service-callcenter.jpg`,
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        image: `${import.meta.env.BASE_URL}images/service-it.jpg`,
      },
      {
        icon: ClipboardList,
        ...
        image: `${import.meta.env.BASE_URL}images/service-pos.jpg`,
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        image: `${import.meta.env.BASE_URL}images/slide-pos-grocery.jpg`,
      },
      {
        icon: Utensils,
        ...
        image: `${import.meta.env.BASE_URL}images/slide-pos-restaurant.jpg`,
      },
      {
        icon: Pill,
        title: "POS for Pharmacy",
        desc: "Pharmacy management with medicine inventory, expiry tracking, prescriptions and sales reporting.",
        image: `${import.meta.env.BASE_URL}images/slide-pos-pharmacy.jpg`,
      },
      {
        icon: Factory,
