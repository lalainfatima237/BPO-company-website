...
//     icon: MapPin,
//     title: "Visit Us",
//     value: "Offic#312 Eden Tower Main Boulevard Gullberg 3 LHR",
...
//                 disabled={isPending}
//               >
//                 {isPending ? <><Loader2 className="mr-2 h-5 w-5 animate-spin" /> Sending...</> : <><Send className="mr-2 h-5 w-5" /> Send Message</>}
//               </Button>
...
export function ContactSection() {
  ...
  return (
    <section id="contact" className=" scroll-mt-20 pt-5 pb-20 bg-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-40"
        style={{ backgroundImage: 'radial-gradient(circle at 100% 100%, rgba(99,102,241,0.06) 0%, transparent 50%)' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="max-w-3xl mx-auto mb-12" /* Added mb-20 for spacing */
        >
          <div className="bg-white border border-border/60 rounded-3xl p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] relative overflow-hidden">
            <h4 className="text-2xl font-black mb-8 relative z-10">Send a Message</h4>
